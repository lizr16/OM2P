...
class World(object):
    ...
    def assign_agent_colors(self):
        ...
        adv_colors = dummy_colors
        good_colors = dummy_colors
    ...
    def step(self):
        ...
        for agent in self.scripted_agents:
            ...
            agent.action.u = agent.action_callback(agent, self)  # [for simple_tag_coop] NOTE: need this in the apply_action_force() function
    ...
    def integrate_state(self, p_force):
        for i,entity in enumerate(self.entities):
            ...
            orig_p_pos = copy.deepcopy(entity.state.p_pos)
            entity.state.p_pos += entity.state.p_vel * self.dt
            # print ('orig_pos: {}, p_vel: {}, dt x p_vel: {}, pos: {}'.format(orig_p_pos, entity.state.p_vel, entity.state.p_vel * self.dt, entity.state.p_pos))
