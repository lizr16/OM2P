...
class MultiAgentEnv(gym.Env):
    ...
    def __init__(self, world, reset_callback=None, reward_callback=None, observation_callback=None, info_callback=None, done_callback=None, post_step_callback=None, shared_viewer=True, discrete_action=False):
    ...
    def _step(self, action_n):
        ...
        orig_pos_list = [copy.deepcopy(self.agents[agent_idx].state.p_pos) for agent_idx in range(len(self.agents))]
        obs_n = []
        reward_n = []
        done_n = []
        info_n = {'n': []}
        ...
        for i, agent in enumerate(self.agents):
            ...
            self._set_action(copy.deepcopy(action_n[i]), agent, self.action_space[i]) # modified by ling: 0717
        # advance world state
        self.world.step()
