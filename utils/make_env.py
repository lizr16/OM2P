...
def make_env(scenario_name, benchmark=False, discrete_action=False, num_agents=None, barrier=[]):
    '''
    ...
    # create world
    if(scenario_name == 'simple_spread_2d_3agent'):
        world = scenario.make_world(unavailable_target=barrier)
    else:
    ...
    # done_callback=scenario.dones_func,
